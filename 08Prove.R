...
data <- read.csv("abalone.csv", head=TRUE, sep=",")
summary(data)
...
calc(species, trainSet, testSet, 0.001, 1)    # 0.5307263
calc(species, trainSet, testSet, 0.001, 10)   # 0.5434956
calc(species, trainSet, testSet, 0.001, 100)  # 0.547486

calc(species, trainSet, testSet, 0.01, 1)     # 0.5450918
calc(species, trainSet, testSet, 0.01, 10)    # 0.5442937
calc(species, trainSet, testSet, 0.01, 100)   # 0.557063

calc(species, trainSet, testSet, 0.1, 1)      # 0.5538707
calc(species, trainSet, testSet, 0.1, 10)     # 0.575419
calc(species, trainSet, testSet, 0.1, 100)    # 0.5682362

calc(species, trainSet, testSet, 0.5, 1)      # 0.5674381
calc(species, trainSet, testSet, 0.5, 10)     # 0.5602554
calc(species, trainSet, testSet, 0.5, 100)    # 0.5594573

calc(species, trainSet, testSet, 1, 1)        # 0.5586592
calc(species, trainSet, testSet, 1, 10)       # 0.5442937
calc(species, trainSet, testSet, 1, 100)      # 0.5450918
